...
//        RejectionSampling exact = new RejectionSampling();
        ...
        a.put(J, TRUE);
        a.put(M, TRUE);
//        Distribution dist = exact.EnumerationInferencer(B, a, bn);
//        Distribution dist = exact.rejectionSampling(B, a, bn, 10000);
        Distribution dist = exact.LikelihoodWeighting(B, a, bn, 10000);
