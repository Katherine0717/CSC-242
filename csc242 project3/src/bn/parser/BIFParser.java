/* A Bison bn.bn.base.base.parser, made by GNU Bison 2.5.  */
...
/* As a special exception, you may create a larger work that contains
   part or all of the Bison bn.bn.base.base.parser skeleton and distribute that work
   under terms of your choice, so long as that work isn't itself a
   bn.bn.base.base.parser generator using the skeleton or a modified version thereof
   as a bn.bn.base.base.parser skeleton.  Alternatively, if you modify or redistribute
   the bn.bn.base.base.parser skeleton itself, you may (at your option) remove this
 ...
 * the distributions will surely need the variables defined first. The bn.bn.base.base.examples
...
/**
 * A Bison bn.bn.base.base.parser, automatically generated from <tt>BIFParser.y</tt>.
 *
 * @author LALR (1) bn.bn.base.base.parser skeleton written by Paolo Bonzini.
 */
public class BIFParser
{
    /** Version number for the Bison executable that generated this bn.bn.base.base.parser.  */
    public static final String bisonVersion = "2.5";

    /** Name of the skeleton that generated this bn.bn.base.base.parser.  */
     ...
     * bn.bn.base.base.parser <tt>BIFParser</tt>.
     */
    ...
    /**
     * Instantiates the Bison-generated bn.bn.base.base.parser.
     * @param yylexer The scanner that will supply tokens to the bn.bn.base.base.parser.
     */
     ...
     * output from the bn.bn.base.base.parser are suppressed.
     */
    ...
    /**
     * Return whether error recovery is being done.  In this state, the bn.bn.base.base.parser
  ...
  `--------------------------------*/
    ...
    private String yysyntax_error (int yystate, int tok)
    {
        ...
        /* There are many possibilities here to consider:
           ...
           - Of course, the expected token list depends on states to
             ...
             bn.bn.base.base.parser not to perform extra reductions after fetching a
     ...
     * <p>
     * Usage: java bn.bn.bn.base.base.parser.BIFParser FILE
     * <p>
    ...
    protected void defineVariable(String name, VariableContentItemList items) {
        ...
        if (network != null) {
            ...
            RandomVariable variable = new NamedVariable(name, domain);
    ...
    protected void defineProbability(StringList variableNames, ProbabilityContentEntryList entries) throws ParserException {
        ...
        if (network != null) {
            ...
            for (ProbabilityContentEntry entry : entries) {
                if (entry instanceof ProbabilityEntry) {
                    ...
                    for (RandomVariable given : givens) {
                        Value val = new StringValue(values.next());
                        a.put(given, val);
                    }
            ...
            Set<RandomVariable> parents = new ArraySet<RandomVariable>(givens);
